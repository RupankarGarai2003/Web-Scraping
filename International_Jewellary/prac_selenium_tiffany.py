...
print("This is the data of Tiffany......")
driver.implicitly_wait(3)
driver.maximize_window()

click_1=driver.find_element(By.XPATH,"/html/body/div[1]/div[3]/div/div/div/header/div[1]/div[1]/div[2]/button/div")
click_1.click()
search=driver.find_element(By.ID,'searchInput')
search.click()
search.send_keys("men")
search.submit()
